...
1. **Upload your content** using [Add Knowledge Memories](/api-reference/endpoint/add-knowledge-memories) or ingestion endpoints
2. **Use recall** via [Smart Recall](/api-reference/endpoint/smart) or [Keyword](/api-reference/endpoint/keyword) endpoints
...
2. **Can I customise entity extraction?**  
