...
<Note>
**Memory ID Source**: Memory IDs (id) can be obtained from the [List User Memories](/api-reference/endpoint/list-user-memories) endpoint or from the response of [Add User Memory](/api-reference/endpoint/add-user-memory) and [Generate User Memory](/api-reference/endpoint/generate-user-memory) endpoints.
</Note>
