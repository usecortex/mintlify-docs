...
description: 'API reference for Delete User Memory.'
...
<Note>
**Memory ID Source**: Memory IDs (`id`) are returned in the response when you add memories via [Add Memory](/api-reference/endpoint/add-memories). Store these IDs in your application so you can reference them for deletion.
</Note>

<Info>
**Best Practices**:
- Store memory IDs from Add Memory responses for later deletion
