...
<Note>
**Memory ID**: Memory IDs (`id`) are returned in the response when you add memories via [Add Memory](/api-reference/endpoint/add-memories). Store these IDs in your application so you can reference them for deletion.
</Note>
