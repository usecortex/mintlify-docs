...
**Cortex Self-hosted**: This option allows you to fully host and manage the solution, giving you the utmost control. Additionally, we offer access to Cortex's source code, empowering your engineering team to build upon and customise our foundational technology according to your specific needs.
...
If you have suggestions on what approach you think works great for core infrastructure products like Cortex, we're all ears. Please write to us at [founders@usecortex.ai](mailto:founders@usecortex.ai) 