...
These are the atoms that power your retrievals. Any context you or your users add is treated as knowledge for the retrieval engine to search and retrieve. This includes any type of documents, chats, images, webpages, presentations, reports, any form of unstructured information. Cortex can also digest CSVs.
...
- Think of it as a long-term cache of user profiles" or "a user's profile—not just what they said, but what they meant and what they’ve done before. Their preferences, intentions, and statements.
